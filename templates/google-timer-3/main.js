(() => {
  const root = document.querySelector('.google-timer-3');
  const rawTimer = root?.querySelector('[data-timer="main"]');
  const visual = root?.querySelector('[data-google-timer-3-visual]');
  let observer = null;
  ...
  const createPart = (value) => {
    ...
    node.className = 'google-timer-3__part';
  ...
  const createColon = () => {
    const node = document.createElement('span');
    node.className = 'google-timer-3__colon';
    node.setAttribute('aria-hidden', 'true');

    const topDot = document.createElement('span');
    topDot.className = 'google-timer-3__colon-dot google-timer-3__colon-dot--top';

    const bottomDot = document.createElement('span');
    bottomDot.className = 'google-timer-3__colon-dot google-timer-3__colon-dot--bottom';
