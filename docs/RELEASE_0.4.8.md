...
- Подтверждено на реальном сценарии: после закрытия vMix Akai подключается нормально.
...
- Confirmed in a real scenario: after closing vMix, Akai connects normally.
